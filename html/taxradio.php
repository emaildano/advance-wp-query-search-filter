...
if ( $count > 0 ){
	...
	echo '<label><input type="radio" id="taxo-'.$c.'" name="taxo['.$c.'][term]" value="wqsftaxoall" ',(isset($_GET['taxo'][$c]['term']) &&  $_GET['taxo'][$c]['term']=='wqsftaxoall') ? 'checked="checked"' : '','>'.$v['taxall'].'</label>';
